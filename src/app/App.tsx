...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            <button
              ...
              className="lg:hidden p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
            ...
            <h1 
              ...
              className="text-lg sm:text-xl lg:text-2xl cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 transition-colors whitespace-nowrap dark:text-white"
            >
              📚 BookConnect
            </h1>
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              >
                {theme === 'light' ? (
                  <Moon size={20} className="sm:w-6 sm:h-6 text-gray-700 dark:text-gray-200" />
                ) : (
              ...
              <button
                ...
                className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 relative"
              >
                <Bell size={20} className="sm:w-6 sm:h-6 dark:text-gray-200" />
      ...
      {/* Navigation */}
      <nav className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-[69px] sm:top-[73px] md:top-[89px] z-40 transition-colors" aria-label="Navegação principal">
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-1.5 sm:gap-2 px-2 sm:px-4 py-2.5 sm:py-3 border-b-2 transition-colors whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:text-base ${
                    isActive
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6 lg:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
          ...
          {navigation.screen === 'home' && (
            <aside className="lg:col-span-3 space-y-4 sm:space-y-6">
              <section className="bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-xl p-4 sm:p-6" aria-label="Anúncio">
                <h3 className="mb-2">Descubra Novos Autores</h3>
                <p className="text-sm mb-4 opacity-90">
                  Participe do nosso evento mensal e conheça autores incríveis!
                </p>
                <button className="bg-white text-blue-600 px-4 py-2 rounded-full hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-500 text-sm sm:text-base">
                  Saiba Mais
                </button>
              </section>

              <section className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 sm:p-6 transition-colors">
                <h3 className="mb-4 dark:text-white">Usuários Sugeridos</h3>
                    ...
                    <div key={index} className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <p className="text-sm dark:text-white truncate">{user.name}</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400">{user.books} livros</p>
                        </div>
                      </div>
                      <button className="text-sm text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-2 py-1 whitespace-nowrap flex-shrink-0">
                        Seguir
                      </button>
                    </div>
                  ))}
