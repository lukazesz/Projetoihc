    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 sm:p-6 transition-colors">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl dark:text-white">Metas de Leitura</h2>
        </div>
        
        <div className="space-y-4">
          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-400">Meta Anual</span>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-400">Meta Mensal (Dezembro)</span>
              <span className="text-sm dark:text-gray-300">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 sm:p-6 transition-colors">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl dark:text-white">Conquistas</h2>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
          {achievements.map((achievement, index) => (
            ...
            >
              ...
              <h4 className="text-xs sm:text-sm mb-1 dark:text-white">{achievement.title}</h4>
              <p className="text-xs text-gray-600 dark:text-gray-400">{achievement.description}</p>
              {achievement.earned && (
                <div className="mt-2 text-xs text-yellow-600 dark:text-yellow-400">✓ Conquistado</div>
              )}
            </div>
          ))}
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 sm:p-6 transition-colors">
        <h2 className="text-xl mb-4 dark:text-white">Minha Biblioteca ({myBooks.length} livros)</h2>
